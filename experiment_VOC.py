...
#model = deeplab_v3_ResNet50(front_end,  num_classes)
model = PSPNet(front_end, num_classes)
#model = FCN(front_end,  32, num_classes)

d_train, d_val = load_VOC(VOC_home, 255, resize_shape, num_train=12000, num_val=12000, data_set=False)

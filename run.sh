...
# segmentation
 C:/Users/admin/Anaconda3/python.exe run_estimator.py --dataset ISPRS --front_end SRes101@32 --model FCN32s --crop_size 513,513 --batch_size 8 --epochs 1000 --learning_rate 0.007 --mode t --datalist_train train.txt --datalist_val val.txt
